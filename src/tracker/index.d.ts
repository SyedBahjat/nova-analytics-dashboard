export type TrackedProperties = {
   ...
   * @example 'analytics.novaanalytics.io'
   */
  hostname: string;
   ...
   *
   * @description extracted from `window.navigator.language`
   * @example 'https://analytics.novaanalytics.io/docs/getting-started'
   */
  referrer: string;
...
export type NovaTracker = {
  track: {
     ...
     *
     * @example ```
     * nova.track('signup-button', { name: 'newsletter', id: 123 });
     * ```
     */
     ...
     *
     * @example ```
     * nova.track({ website: 'e676c9b4-11e4-4ef1-a4d7-87001773e9f2', url: '/home', title: 'Home page' });
     * ```
     */
     ...
     *
     * @example ```
     * nova.track((props) => ({ ...props, url: path }));
     * ```
     */
