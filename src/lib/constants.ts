...
export const AUTH_TOKEN = 'nova.auth';
export const LOCALE_CONFIG = 'nova.locale';
export const TIMEZONE_CONFIG = 'nova.timezone';
export const DATE_RANGE_CONFIG = 'nova.date-range';
export const THEME_CONFIG = 'nova.theme';
export const DASHBOARD_CONFIG = 'nova.dashboard';
export const LAST_TEAM_CONFIG = 'nova.last-team';
export const VERSION_CHECK = 'nova.version-check';
export const SHARE_TOKEN_HEADER = 'x-nova-share-token';
export const HOMEPAGE_URL = 'https://novaanalytics.io';
export const DOCS_URL = 'https://novaanalytics.io/docs';
export const REPO_URL = 'https://github.com/SyedBahjat/nova-analytics-dashboard';
// Telemetry/update endpoints disabled — Nova Analytics doesn't phone home.
